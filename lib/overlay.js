...
(function( global, factory ) {
    ...
    Overlay.prototype._init = function() {
        ...
        if( !opts.animClass && supportAnim ) {
            ...
            opts.animClass.enter = 'overlay-' + ( config.anim[opts.anim] ? config.anim[opts.anim].enter : ( opts.anim + 'enter' ) );
            opts.animClass.leave = 'overlay-' + ( config.anim[opts.anim] ? config.anim[opts.anim].leave : ( opts.anim + 'leave' ) );
        }
